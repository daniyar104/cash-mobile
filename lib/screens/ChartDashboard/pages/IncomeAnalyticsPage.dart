...
class IncomeAnalyticsPage extends StatefulWidget {
  ...
  @override
  State<IncomeAnalyticsPage> createState() => _IncomeAnalyticsPageState();
}

class _IncomeAnalyticsPageState extends State<IncomeAnalyticsPage> {
  ...
  Future<void> _loadIncome() async {
    ...
    final txs = await _dbHelper.getUserIncomes(userId);
          ...
          Expanded(
            child: ListView(
              children: chartData.map((e) {
                final percent = ((e.amount / totalIncome) * 100).toStringAsFixed(1);
                return ListTile(
                  leading: const Icon(Icons.label_important, color: Colors.lightBlue),
